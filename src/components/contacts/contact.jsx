    ...
    <section id="contact" className="container">
        <div className="contacts">
          ...
          <div className="contacts-list">
            ...
            <a className="contact-icon" href="https://www.linkedin.com/in/vincent-ho-1099a3195/"><i className='bx icons'><img className="linkedin" src={process.env.PUBLIC_URL + "/img/linkedin.png"}/></i></a>
            <a className="contact-icon" href="mailto:vincentkcho627@gmail.com"><i className='bx icons' ><img className="mail" src={process.env.PUBLIC_URL + "/img/mail.webp"}/></i></a>
          </div>
